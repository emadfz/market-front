          ...
          <div class="shopping-leftcol">
              ...
              <table class="table table-bordered cart-table mobile-table">
                ...
                <tbody>
                <?php 
                foreach(Cart::instance('watchlist')->content() as $row) :?>
                  <tr>
                    ...
                    <td class="col5" data-title="Action">
                    	...
                    	<a href="javascript: void(0);" onclick="removefromwatchlist('{{$row->rowId}}')" title="Remove from Wishlist" class="text-danger">Remove from Watchlist</a>
                    </td>
                  </tr>
                  <?php endforeach;?>
                </tbody>
