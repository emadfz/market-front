...
<section class="content">
    <div class="container"> 
      ...
      <ul class="myactivity-tab clearfix">
        <li class="active"><a href="{{route('favorite')}}" title="Review Order">Favorite</a></li>
        <li><a href="{{route('watchlist')}}" title="Incomplete Orders">Watchlist</a></li>
      </ul>
      <!-- Nav tabs End-->
      <div class="shoppingcart">
        @include('front.cart.wishlist')
      </div>
    </div>
  </section>
@endsection
...
function removefromwishlist(id){
        ...
        toastr.success("wishlist:  Item has been removed from the wishlist.",'',{
  "closeButton": true,
  "debug": false,
  "positionClass": "toast-top-right",
  "onclick": null,
  ...
  "hideMethod": "fadeOut"
    ...
    function addtowatchlist(id,qty,rowId){
        $.ajax({
            url: '{{route("watchlist")}}',
            type: 'POST',
            dataType: 'json',
            data: {method: '_POST', product_id: id,rowId: rowId, submit: true},
            success: function (r) {
                //$(".cartcontent").html(r['count']);
            },
            error: function (data) {
