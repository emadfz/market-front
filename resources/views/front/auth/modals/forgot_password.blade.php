...
$secretQuestionListPopup = $this->secretQuestion->getSecretQuestion('', true);
?>
<div class="modal" id="forgotModal" tabindex="-1">
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            {!! Form::open(['route' => 'postForgotPassword', 'class' => 'forgot-password-ajax', 'id' => 'forgotPasswordForm', 'autocomplete' => 'off']) !!}
...
<!--                                <input type="email" class="form-control" id="fpemail" placeholder="">-->
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                {!! Form::select('secret_question', $secretQuestionListPopup, null, ['class'=>'selectpicker', 'id' => 'forgot_secret_question']) !!}
                            </div>
                        </div>
