          ...
          @for($x=0 ; $x <10 ; $x++)
            ...
            <div class="item">
                ...
                <div class="item-detail">
                    ...
                    <div class="price"><del><em><?php print(convert_currency( 80 , session()->get('currency_rate')));?></em></del><span><?php print(convert_currency( 30 , session()->get('currency_rate')));?></span></div>
                </div>
