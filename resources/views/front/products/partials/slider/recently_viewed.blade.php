 <div class="col-lg-12 panel-product">
       ...
       <div class="homepage-carousel">
        <ul class="bxcarousel_Recentlyview">
        @for($x=1 ; $x<10 ; $x++)
          <li>
            <div class="item">
                ...
                <div class="item-detail">
                    ...
                    <div class="price"><del><em><?php print(convert_currency( 70 , session()->get('currency_rate')));?></em></del><span><?php print(convert_currency(100, session()->get('currency_rate')));?></span></div>
                </div>
