<div class="subshowbox mos-auction-setting-div {{$mosType}}" style="display: none;">
    <div class="form-group clearfix">
        ...
        <div class="col-md-4">
            {!! Form::text($mosType.'[max_product_price]', (@$updateFlag == TRUE && !empty($productData['productAuction']))?$productData['productAuction']['max_product_price']:null, ['class'=>"form-control $mosType.max_product_price", 'placeholder'=>'', 'id' => "$mosType.max_product_price"]) !!}
        </div>
    </div>
    <div class="form-group clearfix">
        ...
        <div class="col-md-4 clearfix">
            <div class="col-md-6 nopadding">
                <div class="outer-field dateouter">
                    {!! Form::text($mosType.'[start_datetime]', (@$updateFlag == TRUE && !empty($productData['productAuction']))?date('d-M-Y',strtotime($productData['productAuction']['start_datetime'])):null, ['class'=>"form-control col-md-6 datepicker-ui $mosType.start_datetime", 'placeholder'=>'', 'id' => $mosType.'start_datetime']) !!}
                </div>
            </div>
            <div class="col-md-6 nopadding">
                <div class="outer-field dateouter">
                    {!! Form::text($mosType.'[end_datetime]', (@$updateFlag == TRUE && !empty($productData['productAuction']))?date('d-M-Y',strtotime($productData['productAuction']['end_datetime'])):null, ['class'=>"form-control col-md-6 datepicker-ui $mosType.end_datetime", 'placeholder'=>'', 'id' => $mosType.'end_datetime']) !!}
                </div>
            </div>
        </div>
    </div>
