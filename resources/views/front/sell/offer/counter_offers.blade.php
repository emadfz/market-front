...
{!! Form::open(['url' => route('sendCounterOffer',[encrypt($offer[0]->id)]),'class'=>'ajax', 'id'=>'counter_offer_form']) !!}
                    ...
                    <ul class="conversion-chat">
                        @if( isset($offer) && !empty($offer) )
                            @foreach($offer[0]->offerAllDetails as $offer)
                                <li>
                                    <span class="whooffer">Buyer {{ $offer['offer_status'] }}</span>
