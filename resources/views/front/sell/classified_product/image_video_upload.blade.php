                    ...
                    <div class="row">
                        <div class="col-md-12">                                                        
                            <div class="dropzone dropzone-file-area" id="my-dropzone">
                                <h4 class="sbold">Drop files here or click to upload product images, Maximum Number of files upload at a time is 5</h4>
                            </div>
                        </div>
                    </div>    
                </div>
...
var myDropzone = new Dropzone("#my-dropzone", {
    ...
    maxFilesize: 2, //in MB,
    url: '<?php echo route("uploadClassifiedImage", [$productId]); ?>',
    addRemoveLinks: true,
    init: function () {
