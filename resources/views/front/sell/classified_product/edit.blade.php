...
{!! Form::open(['route' => ['editSaveClassifiedProduct', encrypt($classifiedDetails['id'])], 'class' => ' ajax', 'method' =>'post', 'files'=>true, 'id' => 'productFormSubmitId'])!!}
        @include('front.sell.classified_product.edit_form')
{!! Form::close() !!}
