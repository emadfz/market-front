...
<!--Rightside Start -->
{!! Form::open(['url' => route('storeEdit',[encrypt($addDetails[0]->id)]),'class'=>'ajax','id'=>'post_add_form','enctype'=>'multipart/form-data']) !!}
    ...
    <div class="row">
      <div class="form-horizontal col-md-12">
        <div class="form-group">
          ...
          <div class="col-md-4"> 
            <input type="text" class="form-control" name="advertisement_name" value="{{ $addDetails[0]->advr_name }}">
          </div>
        </div>
          ...
          <div class="col-md-10">
            <div class="custom-radio">
              ...
              <label for="adbox">
                ...
                @else
                <input id="adbanner" type="radio" value="Banner" name="type">
                <span></span>Banner Ad
              </label>
              <label for="adbox">
                <input id="adbox" type="radio" value="Main_Box" name="type" checked="">
                <span></span>Main Ad
              </label>
                @endif
            </div>
          ...
          <div class="col-md-10">
            <div class="custom-radio">
              ...
              <label for="adssubcat">
                ...
                @elseif($addDetails[0]->location == 'Category' || $addDetails[0]->location == 'SubCategory')
                {{--*/ $style = 'display:block'; /*--}}
                <input id="adshome" type="radio" value="adhomepage" name="location">
                <span></span>Home Page</label>
              <label for="adscat">
                <input id="adscat" type="radio" value="adcategory" name="location"  checked="">
                <span></span>Category Page</label>
              <label for="adssubcat">
                <input id="adssubcat" type="radio" value="admingle" name="location">
                <span></span>Mingle</label>
                @elseif($addDetails[0]->location == 'Mingle')
                {{--*/ $style = 'display:none'; /*--}}
                <input id="adshome" type="radio" value="adhomepage" name="location">
                <span></span>Home Page</label>
              <label for="adscat">
                ...
                <span></span>Category Page</label>
              <label for="adssubcat">
                <input id="adssubcat" type="radio" value="admingle" name="location" checked="">
                <span></span>Mingle</label>
                @endif
            </div>
          </div>
        ...
        <div style="{{ @$style }}" id="post_add_category">
        ...
        <div class="form-group mrg-bott10">
          ...
          <div class="col-md-4">
            <div class="outer-field dateouter">
              <input type="text" class="form-control datepicker-ui" mindate="0" name="start_date" value="{{date('d-M-Y',strtotime($addDetails[0]->start_date))}}">
            </div>
          </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <div class="col-md-4 selectbox">
            <select class="selectpicker" data-width="100px" name="no_of_days">
              @if($addDetails[0]->days == 7)
              <option selected="selected">7</option>
              <option >15</option>
              <option>30</option>
              @elseif($addDetails[0]->days == 15)
              <option>7</option>
              <option selected="selected">15</option>
              <option>30</option>
              @elseif($addDetails[0]->days == 30)
              <option>7</option>
              <option>15</option>
        ...
        <div class="form-group">
          ...
          <div class="col-md-4">
            <input type="text" class="form-control" placeholder="Devanche.com/#p=product_details_page" name="advertisement_link" value="{{$addDetails[0]->ad_url}}">
          </div>
        </div>
        <hr>
        ...
        <a href="{{ route('advertisements') }}"   class="btn btn-lightgray" title="Close">Close</a>
      	<a href="#large" id="id_preview" style="display:none" data-toggle="modal" class="btn btn-lightgray" title="Show Preview">Show Preview</a>
