...
// print_r($order_billing);
// echo "<br><br>";

// print_r($order_payment);	
// echo "<br><br>";

// print_r($order_shipment);
?>
...
<div class="rightcol-bg clearfix  buy-orderinfo" id="pdf" >
    <div class="equal-column" id="printableArea">
        ...
        <div class="advance-filter">
            <div class="pull-right">
                <ul class="invoice-icon clearfix">
                    <li class="prints"><a  class='no-print' href="#" onclick="printDiv('printableArea')" id="bypassme" title="Print"><span></span>Print</a></li>
                    <li class="downloads"><a  class='no-print' href="#" id="bypassme" onclick="javascript:demoFromHTML()"title="Email"><span></span>Download</a></li>
                </ul>
            </div>
        ...
        <div class="table-responsive noborder">
            <table class="table without-border"   style="width:auto!impoertant;">
                <tr>
                    ...
                    <td class="col2">{{$order->created_at->toDayDateTimeString()}}
                    </td>
        ...
        <div class="itemorder-total text-right">
            <div>Sub Total:<span>${{$total}}</span></div>
