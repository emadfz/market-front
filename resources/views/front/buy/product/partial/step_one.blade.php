        ...
        <div class="row">
            <div class="form-horizontal col-md-12">
                <div class="form-group">
                    ...
                    <div class="selectbox col-md-4">
                        {!! Form::select('occassion_id', $occasions, null, ['class'=>'selectpicker', 'id' => 'occasion']) !!}
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="form-horizontal col-md-12">
                <div class="form-group">
                    ...
                    <div class="selectbox col-md-4">
                        <input type="text" class="form-control" disabled placeholder="123456">
                    </div>
                </div>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    @if($updateFlag == TRUE && $productData['warranty_applicable'] == 'Yes')
    ...
    @if($updateFlag == TRUE && $productData['return_applicable'] == 'Yes')
