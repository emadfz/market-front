<div class="form-group clearfix">
    ...
    <div class="col-md-4">
        {!! Form::text($mosType.'[base_price]', (@$updateFlag == TRUE)?$productData['base_price']:null, ['class'=>"check_numeric form-control $mosType.base_price", 'placeholder'=>'', 'id' => 'base_price']) !!}
    </div>
