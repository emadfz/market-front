            ...
            <div class="row">
                <div class="col-md-12">
                    <ul class="breadcrumb">
                        ...
                        <li><a href="account.html">Terms & Conditions</a></li>
                                    ...
                                    <div class="panel-group witharrow" id="Faqaccordion" role="tablist" aria-multiselectable="true">
                                        ...
                                        <div class="panel panel-default">
                                            <div class="panel-heading" role="tab" id="Faq{{$x}}">
                                                <h4 class="panel-title"> <a role="button" data-toggle="collapse" data-parent="#Faqaccordion" href="#collapse{{$x}}" aria-expanded="false" aria-controls="collapse{{$x}}">{{$term->topic_name}}</a></h4>
                                            </div>
                                            <div id="collapse{{$x}}" class="panel-collapse collapse @if($x ==1) in @endif" role="tabpanel" aria-labelledby="Faq{{$x}}">
                                                <div class="panel-body">{!!$term->terms_conditions!!}</div>
                                            </div>
                                        </div>
                                            {{!$x++}}
